...
//    private float pencilSize = 0.00125f;
//    [Range(0, 2)]
//    public float pencilCorection = 0.35f;
//    [Range(0, 1)]
...
//    public Color backColor = new Color(1f, 1f, 1f, 1f);
...
//            material.SetFloat("_Value2", pencilCorection);
...
using System.Collections;
[ExecuteInEditMode]
[AddComponentMenu("Camera/Shader_Gator")]
[RequireComponent(typeof(Camera))]
public class drawingpaper : MonoBehaviour
{
    #region Variables
